        ...
        3: function(t, e, n) {
            ...
            var re = (function() {
                function t(e) {
                    ...
                    (this.context = e),
                    (this.$editingArea = e.layoutInfo.editingArea),
                    (this.options = e.options), !0 === this.options.inheritPlaceholder &&
                ...
                return (
                    ...
                    (n = [{
                        ...
                        },
                        {
                            key: "update",
                            value: function() {
                                var t = !this.context.invoke("codeview.isActivated") &&
                            ...
                            value: function() {
                                ...
                                for (
                                    var e = function(e, n) {
                                        ...
                                        n = 0,
                                        o = this.options.styleTags.length; n < o; n++
                                )
                                    e(n);
                                this.context.memo("button.bold", function() {
                                    ...
                                    this.context.memo("button.strikethrough", function() {
                                        return t
                                            .button({
                                                ...
                                                tooltip: t.lang.font.strikethrough +
                                    ...
                                    this.context.memo("button.color", function() {
                                        return t.colorPalette(
                                            "note-color-all",
                                            t.lang.color.recent, !0, !0
                                        );
                                    }),
                                    this.context.memo("button.forecolor", function() {
                                        return t.colorPalette(
                                            "note-color-fore",
                                            t.lang.color.foreground, !1, !0
                                        );
                                    }),
                                    this.context.memo("button.backcolor", function() {
                                        return t.colorPalette(
                                            "note-color-back",
                                            t.lang.color.background, !0, !1
                                        );
                                    }),
                                    this.context.memo("button.ul", function() {
                                        return t
                                            .button({
                                                ...
                                                tooltip: t.lang.lists.unordered +
                                ...
                                var r = this.button({
                                    ...
                                    a = this.button({
                                        ...
                                        tooltip: this.lang.paragraph.center +
                                    ...
                                    s = this.button({
                                        ...
                                        tooltip: this.lang.paragraph.right +
                                    ...
                                    l = this.button({
                                        ...
                                        tooltip: this.lang.paragraph.justify +
                                            this.representShortcut("justifyFull"),
                                        click: this.context.createInvokeHandler("editor.justifyFull"),
                                    }),
                                    c = this.button({
                                        contents: this.ui.icon(this.options.icons.outdent),
                                        tooltip: this.lang.paragraph.outdent +
                                            this.representShortcut("outdent"),
                                        click: this.context.createInvokeHandler("editor.outdent"),
                                    }),
                                    u = this.button({
                                        contents: this.ui.icon(this.options.icons.indent),
                                        tooltip: this.lang.paragraph.indent +
                            ...
                            value: function(t) {
                                ...
                                if (n && 11 === n[1].length) {
                                    ...
                                    if (void 0 !== n[2]) {
                                        ...
                                        if (g)
                                            for (
                                                var b = [3600, 60, 1], k = 0, y = b.length; k < y; k++
                                            )
                                                v +=
                                                void 0 !== g[k + 1] ?
