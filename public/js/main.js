...
function setLanguage(lang) {
  switch (lang) {
    case "en":
      document.getElementById("header-lang-img").src = "/imagesflag/us.svg";
      document.getElementById("header-lang-img").title = "English";
      break;
    case "sp":
      document.getElementById("header-lang-img").src = "/imagesflag/es.svg";
      document.getElementById("header-lang-img").title = "Spanish";
      break;
    case "fr":
      document.getElementById("header-lang-img").src = "/imagesflag/fr.svg";
      document.getElementById("header-lang-img").title = "French";
      break;
    case "it":
      document.getElementById("header-lang-img").src = "/imagesflag/it.svg";
      document.getElementById("header-lang-img").title = "Italy";
      break;
    case "ar":
      document.getElementById("header-lang-img").src = "/imagesflag/ar.svg";
