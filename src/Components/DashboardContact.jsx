...
export const Contact = () => {
  ...
  return (
    <div
      id="contact-us"
      className="bg-white  dark:bg-blue-500  flex items-center justify-center "
      style={{
        backgroundImage: "url('./images/xt.png')",
        backgroundSize: "cover", // Example size
        ...
        <div className="mt-8">
          <form className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
            ...
            <div className="flex justify-end sm:col-span-2">
              ...
              <svg
                className="absolute left-full bottom-0 translate-x-1/2 transform"
                width={404}
                height={404}
                fill="none"
                viewBox="0 0 404 404"
